  ...
  <el-form label-width="80px" :model="addForm" ref="addFormRef" :rules="checkRules">
    ...
    <el-form-item label="省" prop="provinceCode">
      <el-select v-model="addForm.provinceCode" style="width: 100%">
        <el-option
          v-for="d in provinceList" :key="d.code" :label="d.name" :value="d.code"
        />
      </el-select>
    </el-form-item>
    <el-form-item label="市" prop="cityCode">
      <el-select v-model="addForm.cityCode" style="width: 100%">
        <el-option
          v-for="d in cityList" :key="d.code" :label="d.name" :value="d.code"
        />
      </el-select>
    </el-form-item>
    <el-form-item label="县" prop="areaCode">
      <el-select v-model="addForm.areaCode" style="width: 100%">
        <el-option
          v-for="d in areaList" :key="d.code" :label="d.name" :value="d.code"
        />
      </el-select>
    </el-form-item>
...
function loadSzm() {
  pinyin4jSzm(addForm.value.bomSupplierName).then((r) => {
    addForm.value.bomSupplierCode = r
  })
}

watch(() => addForm.value.provinceCode, (n) => {
  console.info("provinceCode: ", n)
  addForm.value.cityCode = null
