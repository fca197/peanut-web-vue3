    ...
    <el-card class="search-wrapper" shadow="never">
      <el-form v-model="queryForm" inline>
        <el-form-item label="${column.comment}" prop="shiftId">
          <el-input v-model="queryForm.shiftId" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
        <el-form-item label="${column.comment}" prop="beginTime">
          <el-input v-model="queryForm.beginTime" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
        <el-form-item label="${column.comment}" prop="endTime">
          <el-input v-model="queryForm.endTime" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
