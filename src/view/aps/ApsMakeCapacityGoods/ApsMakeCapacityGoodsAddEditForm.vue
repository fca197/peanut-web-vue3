<template>
  <el-form label-width="80px" :model="addForm" ref="addFormRef" :rules="checkRules">
    <el-form-item label="工厂" prop="factoryId">
      <el-select v-model="addForm.factoryId" @change="addForm.goodsId = undefined">
        <el-option v-for="f in factoryList" :value="f.id" :label="f.factoryName" :key="f.id"/>
      </el-select>
    </el-form-item>
    <el-form-item label="商品" prop="goodsId">
      <el-select v-model="addForm.goodsId">
        <el-option v-for="f in goodsList.filter(t=>t.factoryId === addForm.factoryId)" :value="f.id" :label="f.goodsName" :key="f.id"/>
      </el-select>
    </el-form-item>
