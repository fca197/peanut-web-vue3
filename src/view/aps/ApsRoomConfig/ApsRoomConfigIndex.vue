    ...
    <el-card class="search-wrapper" shadow="never">
      <el-form v-model="queryForm" inline>
        <el-form-item label="${column.comment}" prop="roomId">
          <el-input v-model="queryForm.roomId" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
        <el-form-item label="${column.comment}" prop="sectionId">
          <el-input v-model="queryForm.sectionId" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
        <el-form-item label="${column.comment}" prop="stationId">
          <el-input v-model="queryForm.stationId" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
        ...
        <el-form-item label="${column.comment}" prop="statusId">
          <el-input v-model="queryForm.statusId" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
        <el-form-item>
