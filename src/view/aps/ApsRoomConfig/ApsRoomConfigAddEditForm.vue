...
<template>
  <el-form label-width="80px" :model="addForm" ref="addFormRef" :rules="checkRules">
    ...
    <el-form-item label="${column.comment}" prop="sectionId">
      <el-input v-model="addForm.sectionId" clearable placeholder="请输入${column.comment}"/>
    </el-form-item>
    <el-form-item label="${column.comment}" prop="stationId">
      <el-input v-model="addForm.stationId" clearable placeholder="请输入${column.comment}"/>
    </el-form-item>
    <el-form-item label="${column.comment}" prop="executeTime">
      <el-input v-model="addForm.executeTime" clearable placeholder="请输入${column.comment}"/>
    </el-form-item>
    <el-form-item label="工厂" prop="factoryId">
      <el-input v-model="addForm.factoryId" clearable placeholder="请输入工厂ID"/>
    </el-form-item>
    <el-form-item label="${column.comment}" prop="statusId">
      <el-input v-model="addForm.statusId" clearable placeholder="请输入${column.comment}"/>
    </el-form-item>
  </el-form>
