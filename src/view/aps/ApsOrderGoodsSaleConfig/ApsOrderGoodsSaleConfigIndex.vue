...
import AddEditFormVue from "./ApsOrderGoodsSaleConfigAddEditForm.vue"
...
// 查询表格
const queryForm = ref<ApsOrderGoodsSaleConfig>({
  orderId: undefined,
  goodsId: undefined,
  configId: undefined,
  factoryId: undefined,
...
// 表格相关
const dataList = ref<ApsOrderGoodsSaleConfig[] >([])
...
// 表格选中事件
const handleSelectionChange = (val: ApsOrderGoodsSaleConfig[]) => {
