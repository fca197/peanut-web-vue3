...
import AddEditFormVue from "./ApsGoodsForecastMainAddEditForm.vue"
...
// 查询表格
const queryForm = ref<ApsGoodsForecastMain>({
  goodsId: undefined,
...
// 表格相关
const dataList = ref<ApsGoodsForecastMain[]>([])
...
// 表格选中事件
const handleSelectionChange = (val: ApsGoodsForecastMain[]) => {
