    ...
    <el-card class="search-wrapper" shadow="never">
      <el-form v-model="queryForm" inline>
        <el-form-item label="生产路径 Id aps_produce_process" prop="produceProcessId">
          <el-input v-model="queryForm.produceProcessId" clearable placeholder="请输入生产路径 Id aps_produce_process" />
        </el-form-item>
        ...
        <el-form-item label="耗时（秒）" prop="machineUseTimeSecond">
          <el-input v-model="queryForm.machineUseTimeSecond" clearable placeholder="请输入耗时（秒）" />
        </el-form-item>
        <el-form-item>
