...
import AddEditFormVue from "./ApsGoodsForecastMainSaleDataAddEditForm.vue"
import TableBar from "@/layouts/components/TableBar/index.vue"
import { ElTable } from "element-plus";
import {HeaderInfo, postResultInfo} from "@@/utils/common-js.ts"
import {type ApsGoodsForecastMainSaleData} from "./ApsGoodsForecastMainSaleDataType.ts"

const dtoUrl = ref<string>("/apsGoodsForecastMainSaleData")
const documentTitle = ref<string>("商品预测主表-销售数据")
const dataBatchDeleteUrl = ref<string>(`${dtoUrl.value}/deleteByIdList`)

// 查询表格
const queryForm = ref<ApsGoodsForecastMainSaleData>({
  goodsId: undefined,
...
// 表格相关
const dataList = ref<ApsGoodsForecastMainSaleData[] >([])
...
// 表格选中事件
const handleSelectionChange = (val: ApsGoodsForecastMainSaleData[]) => {
