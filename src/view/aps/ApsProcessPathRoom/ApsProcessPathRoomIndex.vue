...
// 查询表格
const queryForm = ref<ApsProcessPathRoom>({
...
// 表格相关
const dataList = ref<ApsProcessPathRoom[] >([])
...
// 表格选中事件
function handleSelectionChange(val: ApsProcessPathRoom[]) {
    ...
    <el-card class="search-wrapper" shadow="never">
      <el-form v-model="queryForm" inline>
        <el-form-item label="${column.comment}" prop="processPathId">
          <el-input v-model="queryForm.processPathId" clearable placeholder="请输入${column.comment}" />
        </el-form-item>
